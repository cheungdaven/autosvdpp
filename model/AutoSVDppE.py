...
class AutoSVDpp():
    '''
    This is an efficient version of AutoSVD++.
    '''
    def __init__(self, path_of_feature_file, epochs=30,num_factors=10,
                 gamma1=0.007, gamma2=0.007, lambda1=0.005, lambda2=0.015, beta=0.01):
        self.epochs = epochs
        ...
        for epoch in range(self.epochs):
            for u in uni_users:
                ...
                for i in item_by_users[u]:
                    ...
                    p_im += self.gamma2 * (error  * (V[:,i] + self.beta * self.item_features[i])- self.lambda2 * p_im)
